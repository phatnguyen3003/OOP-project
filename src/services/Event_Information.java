...
public class Event_Information{
    ...
    {
        private String id_sk,ten_sk,ngaytochuc_sk,id_lichtrinh,id_diadiem,id_doi_phutrach;
        ...
        public thongtin_sukien(String id_sk,String ten_sk,String ngaytochuc_sk,String id_lichtrinh,String id_diadiem,String id_doi_phutrach)
        {
            this.id_sk=id_sk;
            this.ten_sk=ten_sk;
            this.ngaytochuc_sk=ngaytochuc_sk;
        ...
        public void set_ngaytochuc_sk(String ngaytochuc_sk)
        {
            this.ngaytochuc_sk=ngaytochuc_sk;
        }
        ...
        public String get_ngaytochuc_sk()
        {
            return ngaytochuc_sk;
        }
    ...
    public static class DanhsachThongtinSukien implements IGeneralService<Event_Information.thongtin_sukien>
    {
    ...
    private List<thongtin_sukien> loadtufile()
        {
            ...
            try(BufferedReader bfr = new BufferedReader(new FileReader(FILE_PATH)))
            {
                ...
                while((Line = bfr.readLine())!=null)
                {
                    ...
                    String ngaytochuc_sk = data_parts[2];
                    String id_lichtrinh = data_parts[3];
                    String id_diadiem = data_parts[4];
                    String id_doi_phutrach = data_parts[5];

                    thongtin_sukien tt_sk = new thongtin_sukien(id_sk,ten_sk,ngaytochuc_sk,id_lichtrinh,id_diadiem,id_doi_phutrach);
        ...
        private Boolean ghifile(List<thongtin_sukien>ds_sk)
        {
            try(BufferedWriter bfw = new BufferedWriter(new FileWriter(FILE_PATH)))
            {
                ...
                {
                    String line = String.join("|",sukien.get_id_sk(),sukien.get_ten_sk(),sukien.get_ngaytochuc_sk(),sukien.get_id_lichtrinh(),sukien.get_id_diadiem(),sukien.get_id_doi_phutrach());
                    bfw.write(line);
                    bfw.newLine();
                }
                return true;
